...
PoolQC — 99.5% NaN (პრაქტიკულად ყველა სახლს აუზი არ ჰქონია)
MiscFeature — 96% NaN
Alley — 93% NaN
Fence — 80% NaN
FireplaceQu — 47% NaN

ეს სვეტები სრულად წავშალე, რადგან ასეთ დროს შევსება უფრო "ხმაურს" შემოიტანს ვიდრე სასარგებლო ინფორმაციას.

Training
Linear Regression
მოდელი ძალიან მარტივია ამ დავალებისთვის. Train და Val RMSE ორივე მაღალია (0.1197 და 0.1594), რაც ნიშნავს რომ მოდელი ვერ სწავლობს მონაცემების პატერნებს სათანადოდ - ეს არის underfitting. Linear Regression ცდილობს პირდაპირი ხაზით აღწეროს დამოკიდებულება, მაგრამ სახლების ფასები ბევრად უფრო რთული პატერნებს მიჰყვება.
PoolQC           1453
MiscFeature      1406
Alley            1369
Fence            1179
...
- რიცხვითი სვეტები — შევავსე შუამდგომი მნიშვნელობით (მედიანა). საშუალოს ნაცვლად მედიანა ავირჩიე, რადგან ის უკიდურეს მნიშვნელობებს ნაკლებად ექვემდებარება. მაგ. LotFrontage-ში ზოგ სახლს ძალიან დიდი ეზო ჰქონდა — საშუალო ამ გამო გაიზრდებოდა და ყველა სახლს "დიდ" ეზოს მივანიჭებდით.

- კატეგორიული სვეტები — შევავსე "None" სტრინგით. ეს ლოგიკური იყო, რადგან მრავალ შემთხვევაში გამოტოვება უბრალოდ ნიშნავდა "არ არის" (მაგ. BsmtQual გამოტოვებული = სარდაფი არ არის).
